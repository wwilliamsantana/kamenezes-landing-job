...
export function Hero() {
  return (
    <article className="py-28 text-stone-500 gap-6 max-w-7xl flex items-center justify-around mx-auto">
      <div className="w-md">
      ...
      <a href="https://www.instagram.com/karen.msantana/" target="_blank">
